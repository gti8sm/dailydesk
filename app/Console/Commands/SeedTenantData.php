...
{
    protected $signature = 'tenant:seed-data';
    protected $description = 'Seed tenant with admin user and test data';
    ...
    public function handle()
    {
        ...
        $this->info("✓ {$familyCount} familles et {$childCount} enfants créés");
