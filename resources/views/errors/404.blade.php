...
<head>
    ...
    <title>Page introuvable — DailyDesk</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center px-4">
    <div class="max-w-md w-full text-center">
        ...
        <p class="text-xl text-gray-600 mb-2">Oups ! Cette page n'existe pas.</p>
        <p class="text-sm text-gray-400 mb-8">La page que vous recherchez a peut-être été déplacée ou supprimée.</p>
