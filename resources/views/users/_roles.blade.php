...
$roleDescriptions = [
    ...
    'alsh' => [
        ...
        'short' => 'Gestion complète de la garderie',
        'details' => [
            'Enregistre les arrivées/départs en garderie',
            ...
            'Recommandé : animateur ALSH, agent de garderie',
        ],
    ],
    'cantine' => [
        'icon' => 'fa-utensils',
        ...
        'bg' => 'bg-orange-50',
        'label' => 'Cuisinier / Agent cantine',
        'short' => 'Gestion de la cantine et des menus',
        'details' => [
            'Marque les présents/absents en cantine',
            'Crée et publie les menus (entrée, plat, garniture, dessert)',
            'Crée des événements cantine (refus, allergie, incident)',
            'Consulte l\'historique et exporte les présences',
            'Limité à son école si une école de rattachement est définie',
            'Recommandé : cuisinier, agent de restauration',
        ],
    ],
    'parent' => [
        'icon' => 'fa-home',
